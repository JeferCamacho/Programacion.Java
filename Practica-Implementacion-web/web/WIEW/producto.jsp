        ...
        <form action="controlador" method="POST"   >
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="ejemplo_email_1"
                       placeholder="Introduce tu Name" name="nombre"> 
            </div>
            <div class="form-group">
                <label for="ejemplo_password_1">codigo</label>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="ejemplo_password_1"
                       placeholder="Introduzca su Email" name="cantidad">
            </div>


            <button type="submit" class="btn btn-default" name="action" value="agregarDocumento">Enviar</button>
        </form>
