        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="Controlador?menu=Productos">Productos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Controlador?menu=Empleados">Empleados</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Controlador?menu=Clientes">Clientes</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Controlador?menu=Ventas">Ventas</a>
                    </li>
                </ul>
                <div class="btn-group">
